    """
    Clipboard History Cli Yko9i
    ===========================
    Zero-dependency command-line tool designed to clean local resources efficiently.
    ...
    APP_NAME    = "Clipboard History Cli Yko9i"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency command-line tool designed to clean local resources efficiently.")
